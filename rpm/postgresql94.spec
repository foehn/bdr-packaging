...
%define gittag bdr-pg/REL9_4_4-1
...
Version:	9.4.4_bdr%{pgbdrrelease}
...
# Strip out -ffast-math from CFLAGS....
CFLAGS=`echo $CFLAGS|xargs -n 1|grep -v ffast-math|xargs -n 100`
# Always build with -fno-omit-frame-pointer so perf can get userspace stacks.
# The cost is negligible, so enable for all builds not just debug.
